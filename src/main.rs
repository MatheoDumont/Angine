...
fn main() {
    ...
    //     Transform::translation(Vec3::new(ZERO, 4.0, ZERO)),
    //     3.0,
    //     false,
    // );
    ...
    let plane_rb = RigidBody::new(Transform::translation(P3::new(0.0, -10.0, 0.0)), 0.0, true);
    ...
    //     UnitQuaternion::<f32>::identity(),
    // );
    simulation_world.pre_start_set_appart();
