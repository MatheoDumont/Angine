...
pub struct SquareMatrix<const SIZE: usize> {
    data: [[Real; SIZE]; SIZE],
}

impl<const SIZE: usize> SquareMatrix<SIZE> {
    pub fn identity() -> SquareMatrix<SIZE> {
        let m = SquareMatrix {
            data: [[ZERO; SIZE]; SIZE],
        };
        for i in 0..SIZE {
    ...
    pub fn zero() -> SquareMatrix<SIZE> {
        SquareMatrix {
            data: [[ZERO; SIZE]; SIZE],
        }
    }

    pub fn value(v: Real) -> SquareMatrix<SIZE> {
        SquareMatrix {
            data: [[v; SIZE]; SIZE],
        }
    }
